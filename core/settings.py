...
CSRF_TRUSTED_ORIGINS = ['http://localhost','http://127.0.0.1:5085','http://localhost:5085','http://127.0.0.1','http://' + env('SERVER', default='127.0.0.1') + ':5085','https://www.newspro.top','http://newspro.top' ]
# Application definition
...
>>>>>>> f3b8a0282069123ac402e77012e1db325251d2d1
