...
CSRF_TRUSTED_ORIGINS = ['http://localhost','http://127.0.0.1:5085','http://localhost:5085','http://127.0.0.1','http://' + env('SERVER', default='127.0.0.1') + ':8000','http://192.168.1.28:5085' ]
